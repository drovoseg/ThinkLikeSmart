...
namespace Tls.ThinkLikeSmart.iOS.ViewControllers.Authentication
{
    public partial class LoginViewController : UIViewController, ILoginView
    {
        ...
        //addObserver:self selector:@selector(onKeyBoardWillShow:) name:UIKeyboardWillShowNotification object:nil];
        //    [[NSNotificationCenter defaultCenter]
        ...
        //     *0表示邮箱登录；1表示手机号登录
        //     */
        //    self.loginType = [[NSUserDefaults standardUserDefaults]
        //integerForKey:@"LOGIN_TYPE"];
        //    [self initComponent];
        ...
        //    self.progressAlert = [[[MBProgressHUD alloc]
        //initWithView:self.view] autorelease];
        ...
        //        field1.layer.borderColor = [[UIColor colorWithRed:200.0/255.0 green:200.0/255.0 blue:200.0/255.0 alpha:1.0]
        //CGColor];
        ...
        //    field1.text = [[NSUserDefaults standardUserDefaults]
        ...
        //        field2.layer.borderColor = [[UIColor colorWithRed:200.0/255.0 green:200.0/255.0 blue:200.0/255.0 alpha:1.0]
        //CGColor];
        ...
        //    field2.text = [[NSUserDefaults standardUserDefaults]
        //objectForKey:@"USER_PWD"];//记住用户的登录密码
        ...
        //    [registerBtn setTitleColor:[UIColor grayColor]
        ...
        //    chooseCountryBtn.layer.borderColor = [[UIColor grayColor]
        //CGColor];
        ...
        //        field3.layer.borderColor = [[UIColor colorWithRed:200.0/255.0 green:200.0/255.0 blue:200.0/255.0 alpha:1.0]
        //CGColor];
        ...
        //    field3.text = [[NSUserDefaults standardUserDefaults]
        ...
        //        field4.layer.borderColor = [[UIColor colorWithRed:200.0/255.0 green:200.0/255.0 blue:200.0/255.0 alpha:1.0]
        //CGColor];
        ...
        //    field4.text = [[NSUserDefaults standardUserDefaults]
        //objectForKey:@"PHONE_PWD"];//记住用户的登录密码
        ...
        //    [registerBtn2 setTitleColor:[UIColor grayColor]
        //forState:UIControlStateNormal];
        ...
        //openURL:[NSURL URLWithString:@"http://www.cloudlinks.cn/pw/"]];
        //}
        ...
        //loginWithUserName:username password:password token:[AppDelegate sharedDefault].token callBack:^(id result){
        ...
        //setObject:password forKey:@"USER_PWD"];
        //        }else{
        //            [[NSUserDefaults standardUserDefaults]
        //setObject:@"" forKey:@"USER_PWD"];
        //        }
        ...
        //                [UDManager setLoginInfo:loginResult];
        //                [[NSUserDefaults standardUserDefaults]
        //setObject:username forKey:@"USER_NAME"];
        //                [[NSUserDefaults standardUserDefaults]
        //setInteger:self.loginType forKey:@"LOGIN_TYPE"];
        //                MainController* mainController = [[MainController alloc] init];
        //                self.view.window.rootViewController = mainController;
        //                [[AppDelegate sharedDefault]
        //setMainController:mainController];
        ...
        //                [[NetManager sharedManager]
        //getAccountInfo:loginResult.contactId sessionId:loginResult.sessionId callBack:^(id JSON){
        ...
        //                //用户登录时，则记下用户的登录密码；用于下次登录时，不用再输入PWD
        //                [[NSUserDefaults standardUserDefaults]
        //setObject:password forKey:@"PHONE_PWD"];
        //            }else{
        //                [[NSUserDefaults standardUserDefaults]
        //setObject:@"" forKey:@"PHONE_PWD"];
        //            }
        //            switch(loginResult.error_code){
        //                case NET_RET_LOGIN_SUCCESS:
        //                {
        ...
        //                    [UDManager setLoginInfo:loginResult];
        //                    [[NSUserDefaults standardUserDefaults]
        //setObject:phone forKey:@"PHONE_NUMBER"];
        //                    [[NSUserDefaults standardUserDefaults]
        //setInteger:self.loginType forKey:@"LOGIN_TYPE"];
        //                    MainController* mainController = [[MainController alloc] init];
        //                    self.view.window.rootViewController = mainController;
